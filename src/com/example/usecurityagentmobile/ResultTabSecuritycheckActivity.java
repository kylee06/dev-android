...
public class ResultTabSecuritycheckActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
	    ...
	    dataArr.add(new ListItem(BitmapFactory.decodeResource(getResources(), R.drawable.ic_launcher),true,"비밀번호 설정 여부",  "Y/N","설정하기",true) );
	    dataArr.add(new ListItem(BitmapFactory.decodeResource(getResources(), R.drawable.ic_launcher),true,"WiFi 설정 여부", "Y/N","설정하기",true) );
	    dataArr.add(new ListItem(BitmapFactory.decodeResource(getResources(), R.drawable.ic_launcher),true,"GPS 설정 여부",  "Y/N","설정하기",true) );
	    dataArr.add(new ListItem(BitmapFactory.decodeResource(getResources(), R.drawable.ic_launcher),true,"미 동의 앱 설치 여부",  "Y/N","설정하기",true) );
